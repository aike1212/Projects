        ...
        <div>
            <ul>
                ...
                <li class="reg">
                    ...
                    <?=form::label("birthday",$usr->birthday)?><br/>
                </li>
                <li class="reg">
                    <strong><?=form::label("number","Contact Number:",'class="profile_info"')?></strong>
                    <?=form::label("contact",$usr->contact_number)?><br/>
                </li>
            </ul>
        </div>
    </fieldset>
...
<p class="edit_profile">
  <?=html::anchor("user/edit_profile","Edit Profile")?>
  <span>&nbsp|&nbsp</span>
  <?=html::anchor("user/change_password","Change Password")?>
</p>