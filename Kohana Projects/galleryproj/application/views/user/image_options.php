    ...
    <div>
      <ul>
        ...
        <li class="reg">
          ...
          <?=text::limit_chars(form::label("image_name","{$image->image_src}","class=\"cContent\""),85,"...")?>
        </li>
        <li class="reg">
        ...
        <li class="reg">
          <?=form::radio('radio_profile', 'is_profile_pic');?>
          <?=form::label('radio_profile', ' Make this your profile picture.');?>
        </li>
        <li class="reg">
...
<span style="margin-left: 500px; margin-right: 30px;"><?=html::anchor("user/manage_photos","Back to image library");?></span>
