<?php
	...
	$websiteInfo = array(
		"website_name"			=> "PhatKat Productions",
		"server_path"			=> "phatkat_fanpage.com/",
		"subfolder_path"		=> "P/" // Change the letter here to subfolder used on server
		);
	
	$clientInfo = array(
		"name_of_client"		=> "Vince Allo",
		"client_email"			=> "vallo@clearchannel.com",
