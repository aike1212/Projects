...
$my_email = "leininger.dean@yahoo.com"; //joesfixitsvcs@yahoo.com
...
$subject = "Mobile Contact Request for Mr. Stump Grinder";
...
$autoresponder_subject = "Your Mobile Contact Request for Mr. Stump Grinder";
...
$fields_to_ignore = array('Submit','submit','recaptcha_challenge_field','recaptcha_response_field','captcha_code','Submit_x','Submit_y');
...
<div>
<center>
<h1>Thank you <?php if(isset($_REQUEST['name'])){print stripslashes($_REQUEST['name']);} ?></h1>
