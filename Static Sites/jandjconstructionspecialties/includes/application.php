<?php
	...
	$websiteInfo = array(
		"website_name"			=> "J and J Construction Specialties, LLC",
		"server_path"			=> "", //jandjconstructionspecialties
		"subfolder_path"		=> "J/" // Change the letter here to subfolder used on server
		);
	
	$clientInfo = array(
		"name_of_client"		=> "David",
		"client_email"			=> "jjconstspec@gmail.com",
