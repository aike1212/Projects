<?php
	...
	$websiteInfo = array(
		"website_name"			=> "1 Off Customz",
		"server_path"			=> "/", // 1offcustomz/
		"subfolder_path"		=> "1/" // Change the letter here to subfolder used on server
		);
	
	$clientInfo = array(
		"name_of_client"		=> "Keith Castle",
		"client_email"			=> "Brian@1offcustomz.com",
