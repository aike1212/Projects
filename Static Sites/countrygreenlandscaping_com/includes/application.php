<?php
	...
	$websiteInfo = array(
		"website_name"			=> "Country Green Professional Landscaping",
		"server_path"			=> "/", //countrygreenlandscaping_com
		"subfolder_path"		=> "C/" // Change the letter here to subfolder used on server
		);
	
	$clientInfo = array(
		"name_of_client"		=> "Jonathan Haas",
		"client_email"			=> "countrygreenlandscaping@gmail.com",
