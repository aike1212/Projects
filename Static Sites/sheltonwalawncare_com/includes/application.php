<?php
	...
	$websiteInfo = array(
		"website_name"			=> "Matt B's Lawn Care",
		"server_path"			=> "sheltonwalawncare_com/",
		"subfolder_path"		=> "m/" // Change the letter here to subfolder used on server
		);
	
	$clientInfo = array(
		"name_of_client"		=> "Matt",
		"client_email"			=> "mattbslawns@yahoo.com",
		"client_web_address"	=> "www.sheltonwalawncare.com",
