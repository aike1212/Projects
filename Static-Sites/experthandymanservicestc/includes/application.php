<?php
	...
	$websiteInfo = array(
		"website_name"			=> "Expert Handyman Services Inc.",
		"server_path"			=> "experthandymanservicestc/", // experthandymanservicestc/
		"subfolder_path"		=> "E/" // Change the letter here to subfolder used on server
		);
	
	$clientInfo = array(
		"name_of_client"		=> "Paul",
		"client_email"			=> "paultyrer@live.com",
