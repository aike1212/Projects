<?php
	...
	$websiteInfo = array(
		"website_name"			=> "luxurywine",
		"server_path"			=> "luxurywine_com/",
		"subfolder_path"		=> "L/" // Change the letter here to subfolder used on server
		);
	
	$clientInfo = array(
		"name_of_client"		=> "David Wolter",
		"client_email"			=> "ef.marquez@yahoo.com",
	...
	function selectHeader1($page_name) {
		switch($page_name) {
			case 'index.php':
				echo '&nbsp;';
				break;
