<?php
	...
	$websiteInfo = array(
		"website_name"			=> "Sheldon Home Improvements Williamstown PA",
		"server_path"			=> "sheldonhomeimprovementswilliamstownpa/", //sheldonhomeimprovementswilliamstownpa/
		"subfolder_path"		=> "s/" // Change the letter here to subfolder used on server
		);
	
	$clientInfo = array(
		"name_of_client"		=> "Sheldon L Crum",
		"client_email"			=> "sheldon10@epix.net",
		...
		"client_email_password"	=> "9YEBAXk6pHGjzWZAjxMRKgNS",
