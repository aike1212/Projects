<?php
	...
	$websiteInfo = array(
		"website_name"			=> "Fish Tales Seafoods",
		"server_path"			=> "fishtalesusa_com/",
		"subfolder_path"		=> "F/" // Change the letter here to subfolder used on server
		);
	
	$clientInfo = array(
		"name_of_client"		=> "Scott",
		"client_email"			=> "lakehoustonre@yahoo.com", //lakehoustonre@yahoo.com
		"client_web_address"	=> "www.fishtalesusa.com",
		"client_smtp_email"		=> "mailer@fishtalesusa.com", //no need to change unless SMTP account created by IT
		"client_email_password"	=> "wer6G934gj8",
