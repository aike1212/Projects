<?php
	...
	$websiteInfo = array(
		"website_name"			=> "The Baking Grounds",
		"server_path"			=> "thebakinggrounds_com/",
		"subfolder_path"		=> "T/" // Change the letter here to subfolder used on server
		);
	
	$clientInfo = array(
		"name_of_client"		=> "Lorne McCaslin",
		"client_email"			=> "lorne.mccaslin@gmail.com",
	...
	function isActiveSidebarLink($category) {
