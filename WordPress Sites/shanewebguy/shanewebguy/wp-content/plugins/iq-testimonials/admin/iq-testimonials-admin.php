...
<?php if (isset($_POST['addQuote'])) { ?>
	<div class="iq-testimonial-updated" id="message" style="background-color: rgb(255, 251, 204);"><p><?php echo ('New testimonial added successfully!'); ?></p></div>
<?php } ?>

<?php if (isset($_POST['editQuote'])) { ?>
	<div class="iq-testimonial-updated" id="message" style="background-color: rgb(255, 251, 204);"><p><?php echo ('Testimonial edited successfully!'); ?></p></div>
<?php } ?>

<?php if (isset($_POST['featQuote']) || isset($_GET['featQuote'])) { ?>
<div class="iq-testimonial-updated" id="message" style="background-color: rgb(255, 251, 204);"><p><?php echo ('Testimonial featured successfully!'); ?></p></div>
<?php } ?>

<?php if (isset($_POST['unfeatQuote']) || isset($_GET['unfeatQuote'])) { ?>
<div class="iq-testimonial-updated" id="message" style="background-color: rgb(255, 251, 204);"><p><?php echo ('Testimonial unfeatured successfully!'); ?></p></div>
<?php } ?>

<?php if (isset($_POST['bulkQuote']) || isset($_GET['bulkQuote'])) { ?>
<div class="iq-testimonial-updated" id="message" style="background-color: rgb(255, 251, 204);"><p><?php echo ('Testimonial status updated successfully!'); ?></p></div>
<?php } ?>

<?php if (isset($_GET['deleteQuote']) || isset($_POST['deleteQuote'])) { ?>
<div class="iq-testimonial-updated" id="message" style="background-color: rgb(255, 251, 204);"><p><?php echo ('Testimonial deleted successfully!'); ?></p></div>
<?php } ?>
...
<form method="post" action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI']); ?>">
	...
	<tbody>
		...
		<tr valign="top">
			<th scope="row"><label for="quote">Testimonial *</label></th>
			<td>
