 ...
 ********************************/	
	...
	$sql12 = ("UPDATE $iq_testimonials_settings SET value='".$testimonial_options['dynamically_rotate']."' WHERE name='dynamically_rotate'");
	$sql13 = ("UPDATE $iq_testimonials_settings SET value='".$testimonial_options['rotation_speed']."' WHERE name='rotation_speed'");
	$sql14 = ("UPDATE $iq_testimonials_settings SET value='".$testimonial_options['fade_speed']."' WHERE name='fade_speed'");
 ...
 ********************************/
	...
	$testimonial_options['form_location'] = 'true';
	$testimonial_options['form_website'] = 'true';
