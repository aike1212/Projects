...
define('IQ_TESTIMONIALS_DB_VERSION', '2.2.0');
...
function iq_testimonials_install(){
	...
	update_option('iq-testimonials-db-version', IQ_TESTIMONIALS_DB_VERSION);
		...
		"VALUES ('1','admin_email','$admin_email'), ('2','date','1'), ('3','max_widget_testimonials','1'), ('4','max_page_testimonials','15'), ('5','max_image_width','125'), ('6','max_image_height','125'), ('7','randomize','1'), ('8','form_name','true'), ('9','form_email','true'), ('10', 'form_location','true'), ('11', 'form_website','true'), ('12', 'dynamically_rotate','true'), ('13', 'rotation_speed','12000'), ('14', 'fade_speed','1000')";
		...
		"VALUES ('12', 'dynamically_rotate','true'), ('13', 'rotation_speed','12000'), ('14', 'fade_speed','1000')";
		...
		while ($data = mysql_fetch_array($results)){
			...
			$imagelink = $data['imagelink'];
				...
				if (!empty($imagelink)) {
					...
					$imagelink = '<img class="alignleft" src="'.$imagelink.'" width="57" height="63" />';
				}			
			...
			$theTestimonial .= $featuredpre . $imagelink .' '. $quote . '<br /><span> <strong>' .$name . '</strong><em>' . $location . '</em>' . $websitepre . $website . $websitesuf . "</span></div>";
