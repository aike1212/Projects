<div>MARKER_DIRECTIONS_HINT_TOKEN<div class="google-map-placeholder" id="MAP_PLACEHOLDER_ID_TOKEN" style="width: MAP_PLACEHOLDER_WIDTH_TOKEN; height: MAP_PLACEHOLDER_HEIGHT_TOKEN;"><div style="background:url('IMAGES_DIRECTORY_URI/loading.gif') no-repeat 0 0 transparent !important; height:100px; width:100px; position: relative; top: LOADING_INDICATOR_TOP_POS_TOKENpx !important;"></div></div>
					...
					<div class="dir-wp-hl">
						...
						<div class="dir-input">
							<div class="kd-input-text-wrp">
                                ...
                                <input type="text" maxlength="2048" tabindex="4" value="" name="a_address" id="a_address" title="Start address" class="wp kd-input-text" autocomplete="off" >
							</div>
						</div>
					</div>
				</div>
					...
					<div class="dir-wp-hl">
						...
						<div class="dir-input">
							<div class="kd-input-text-wrp">
                                ...
                                <input type="text" maxlength="2048" tabindex="4" value="" name="b_address" id="b_address" title="End address" class="wp kd-input-text" autocomplete="off">
							</div>
						</div>
					</div>
				</div>
