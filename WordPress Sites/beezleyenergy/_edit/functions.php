...
function twentyten_widgets_init() {
	...
	register_sidebar( array(
		...
		'id' => 'navigation',
		'description' => __( 'The navigation', 'twentyten' ),
	...
	register_sidebar( array(
		...
		'description' => __( 'The footer navigation', 'twentyten' ),
		'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
		'after_widget' => '</li>',
		'before_title' => '<h3 class="widget-title">',
		'after_title' => '</h3>',
	...
	register_sidebar( array(
		'name' => __( 'Display About Slideshow', 'twentyten' ),
		'id' => 'display-about-slideshow',
		'description' => __( 'Displays Slideshow for about page', 'twentyten' ),
		'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
		'after_widget' => '</li>',
		'before_title' => '<h3 class="widget-title">',
		'after_title' => '</h3>',
	...
	register_sidebar( array(
		'name' => __( 'Display Faq Slideshow', 'twentyten' ),
		'id' => 'display-faq-slideshow',
		'description' => __( 'Displays slideshow for faqs page', 'twentyten' ),
		'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
		'after_widget' => '</li>',
		'before_title' => '<h3 class="widget-title">',
		'after_title' => '</h3>',
...
function wrapperPicker($page) {	
	if ($page == "about-us" || $page == "faq") {
		echo 'class="pageimage-about"';
	} else if ($page == "") {
		echo null;
	} else {
		echo 'class="pageimage-client"';
	}
}
