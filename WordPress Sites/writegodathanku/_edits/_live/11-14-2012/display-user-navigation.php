<!-- Author Profile Navigation -->
	<div id="nav-wrapper" class="left">
		<ul id="menu-profile-menu">
			<li><a href="<?php bloginfo('url'); ?>/profile/" <?php echo is_page('profile') ? "class='active-menu'" : null; ?>>Profile</a></li>
			<li><a href="<?php bloginfo('url'); ?>/write-a-thank-you/" <?php echo is_page('writegodathanku') ? "class='active-menu'" : null; ?>>Write a Thank You</a></li>
			<li>
