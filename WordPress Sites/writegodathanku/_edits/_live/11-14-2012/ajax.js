...
var ajax_url_live = 'http://writegodathankyou.com/';
...
$(document).ready(function() {	
	$('.love-button').click(function() { 
		...
		$.post(ajax_url_live, {user_id:user_id, post_id:post_id, 'action':'yes'}, function(data) {	
	...
	$('input[name=hide-user]').live("click",function() {
		...
		$.post(ajax_url_live+'profile/', {hide_id:id, hide_value:hide, 'action':'yes'}, function(data) {	
