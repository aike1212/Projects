				...
				<form action="" method="post" id="login" class="custom_forms">
					<fieldset>
						...
						<p style="margin:15px 0 40px;">
							...
							<input type="text" id="password-text" name="password-text" value="Enter your password" onfocus="document.getElementById('password-text').style.display = 'none'; document.getElementById('password').focus();" onblur="document.getElementById('password-text').style.display = 'none'; document.getElementById('password').focus();" />
							<br class="clear" />
						</p>
