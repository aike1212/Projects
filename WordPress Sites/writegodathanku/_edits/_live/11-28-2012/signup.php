		...
		<form action="" method="post" class="custom_forms" id="sign_up">
			<fieldset>
				...
				<p>
					...
					<input type="text" id="username" name="username" value="<?php echo (isset($_POST["username"]))? $_POST["username"] : "Enter your username"; ?>" onfocus="clearText(this);" onblur="clearText(this);" maxlength="15" />
					<br class="clear" />
				</p>
