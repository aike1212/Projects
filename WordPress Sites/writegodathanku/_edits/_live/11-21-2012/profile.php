<?php
	...
	if(isset($_GET['session']) && isset($_GET['hash_value'])) {
		session_register("username");
		$_SESSION['login_user'] = $_GET['session'];
		$_SESSION['message'] = "Your registration is complete.";
		
		$wpdb->update(
			'wp_users',
			array('user_pass' => $user_info->new_pass),
			array('sign_up_hash' => $_GET['hash_value'])
		);
	}
...
<?php
		...
		echo '<meta http-equiv="refresh" content="0;url=http://writegodathankyou.com/login">';
	}	
?>