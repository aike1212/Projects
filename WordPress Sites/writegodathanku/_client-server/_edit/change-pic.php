...
if($_FILES){
  ...
  foreach($_FILES as $key => $file){
    ...
    $upload->set("supported_extensions",array("gif" => "image/gif" ,"jpg" => "image/jpeg","jpeg" => "image/jpeg" ,"png" => "image/x-png")); // Allowed extensions and types for uploaded file.
    ...
    $upload->set("dst_dir", $_SERVER['DOCUMENT_ROOT'].'/writegodathanku/wp-content/uploads/'); // Destination directory for uploaded files.
...
<table cellpadding=2 cellspacing=2 border=0 align=center>
  <tr><td>&nbsp;</td></tr>
  <tr>
    <td align=center id="prof-pic-header">Change your Profile Picture</td>
  </tr>
  <tr><td>&nbsp;</td></tr>
  <tr>
    <td>
      <table cellpadding=2 cellspacing=2 border=0 align=center>
        <tr>
          <td><strong id="file-label">File:</strong></td>
          <td>
