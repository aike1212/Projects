<?php
	...
	$websiteInfo = array(
		"website_name"			=> "Naper Towing Services",
		"server_path"			=> "napervilletowingservice.com/fanpage/", //napervilletowingservice.com/fanpage/
		"subfolder_path"		=> "N/" // Change the letter here to subfolder used on server
		);
	
	$clientInfo = array(
		"name_of_client"		=> "George Garbis",
		"client_email"			=> "ggarbis@hotmail.com",
