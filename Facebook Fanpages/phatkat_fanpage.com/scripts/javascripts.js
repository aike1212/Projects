...
$(document).ready(function (){
	...
	$('#wedding-services').pajinate({
		num_page_links_to_display : 3,
		items_per_page : 6/* Display number of items per page */
	});

	/*** Initialize Thumbnail Easing ***/
	$(".gallery a span, .wedding-gallery a span").ready(function(){
		$(".gallery a span").animate({opacity:"0.50",speed:"fast"});
	});

	$(".gallery a, .wedding-gallery a").hover(function() {
